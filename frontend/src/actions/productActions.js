...
export const listVariationDetails = (product, id) => async (dispatch) => {
  try {
...
export const createVariation = (id) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    const { data } = await axios.post(
      `/api/products/${id}/create/variation`,
      {},
      config
    );
...
export const deleteVariation = (pk, id) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const updateVariation =
  (product, variation) => async (dispatch, getState) => {
    try {
      dispatch({
      ...
      const { data } = await axios.put(
        `/api/products/update/${product}/${variation.id}`,
        variation,
        config
      );
